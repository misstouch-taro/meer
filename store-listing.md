...
Peek inside GitHub and GitLab repositories on Windows — no Git knowledge required.
...
### Keywords
GitHub, GitLab, repository viewer, file preview, Git beginner, code review, source code
...
### 簡単な説明（100文字以内）
Gitの知識がなくても、GitHub・GitLabのリポジトリの中身を見られるWindows向けデスクトップアプリ。
...
### キーワード
GitHub, GitLab, リポジトリ閲覧, ファイルプレビュー, Git 初心者, コードレビュー, ソースコード
...
Mira el contenido de repositorios de GitHub y GitLab sin saber Git, desde tu escritorio Windows.
...
### Palabras clave
GitHub, GitLab, visor de repositorios, vista previa de archivos, principiante Git, revisión de código, código fuente
